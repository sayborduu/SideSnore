...
enum OperationError: LocalizedError
{
    ...
    var failureReason: String? {
        ...
        case .unabletoconSideJITDevice return NSLocalizedString("SideJITServer is unable to connect to your iDevice Please pair your Device by doing 'SideJITServer -y'", comment: "")
        case .wrongIP return NSLocalizedString("Incorrect IP Please make sure if you are using the latest version of SideJITServer to clear out the IP Section", comment: "")
